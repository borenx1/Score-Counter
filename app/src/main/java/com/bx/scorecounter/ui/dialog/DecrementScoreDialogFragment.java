...
public class DecrementScoreDialogFragment extends DialogFragment {

    private static final String TAG = "DecrementScoreDialogFragment";
     ...
     */
    @NonNull
    public static DecrementScoreDialogFragment newInstance(@NonNull ScoreData scoreData) {
        final DecrementScoreDialogFragment fragment = new DecrementScoreDialogFragment();
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setView(numberPicker)
                .setTitle(getString(R.string.dialog_decrement_title, getLabel()))
                .setPositiveButton(R.string.yes, (dialog, which) -> listener.onDialogPositiveClick(DecrementScoreDialogFragment.this))
                .setNegativeButton(android.R.string.cancel, (dialog, which) -> listener.onDialogNegativeClick(DecrementScoreDialogFragment.this));
